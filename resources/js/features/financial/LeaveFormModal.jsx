...
export default function LeaveFormModal({
    ...
    const {
        ...
        try {
            ...
            if (isEdit && hasPermission("edit leaves")) {
                ...
                if (
                    formValues.status === LEAVE_STATUS.REJECTED &&
    ...
    useEffect(() => {
        ...
        } else if (!leaveId && (mode === "create" || !mode)) {
            setValues(initialValues);
        }
    }, [leaveData, leaveId, mode, setValues]);
