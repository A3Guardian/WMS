...
export default function InvoiceFormModal({
    ...
    const {
        ...
        try {
            ...
            if (isEdit) {
                ...
                toast.success(t("invoices.form.toast.updated"));
            } else {
                await api.post("/invoices", submitData);
                toast.success(t("invoices.form.toast.created"));
            }
            ...
            toast.error(
                isEdit
                    ? t("invoices.form.toast.updateFailed")
                    : t("invoices.form.toast.createFailed"),
    ...
    const title = isEdit
        ? t("invoices.form.modal.editTitle")
        : t("invoices.form.modal.createTitle");
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-xl p-6 w-full max-w-4xl z-50 max-h-[90vh] overflow-y-auto">
                    ...
                    <Dialog.Description className="text-sm text-gray-500 mb-4">
                        {t("invoices.form.modal.description")}
                    </Dialog.Description>
                    ...
                    >
                            ...
                            <input
                                ...
                                value={
                                    isEdit
                                        ...
                                        : t("invoices.form.autoGenerated")
                                }
                                disabled
                                className="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100"
                            />
                            <p className="mt-1 text-xs text-gray-500">
                                {t("invoices.form.hints.autoGenerated")}
                            </p>
                        </div>

                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t("invoices.form.fields.supplier")}
                            </label>
                            <SearchableSelect
                                ...
                                placeholder={t("invoices.form.placeholders.selectSupplierOptional")}
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t("invoices.form.fields.customer")}
                            </label>
                            <SearchableSelect
                                ...
                                placeholder={t("invoices.form.placeholders.selectCustomerOptional")}
                        ...
                        <div>
                            ...
                            <SearchableSelect
                                ...
                                placeholder={t("invoices.form.placeholders.selectType")}
                            />
                        </div>

                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t("invoices.form.fields.status")}
                            </label>
                            <SearchableSelect
                                value={values.status}
                                onChange={(v) =>
                                ...
                                placeholder={t("invoices.form.placeholders.selectStatus")}
                            />
                        </div>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t("invoices.form.fields.dueDate")}
                            </label>
                            <input
                                type="date"
                                name="due_date"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t("invoices.form.fields.paidDate")}
                            </label>
                            <input
                                type="date"
                                name="paid_date"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t("invoices.form.fields.category")}
                            </label>
                            <input
                                type="text"
                                name="category"
                                ...
                                onChange={handleChange}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md"
                                placeholder={t("invoices.form.placeholders.categoryExample")}
                            />
                        </div>

                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t("invoices.form.fields.subtotal")}{" "}
                                <span className="text-red-500">*</span>
                            </label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t("invoices.form.fields.taxAmount")}
                            </label>
                            <input
                                type="number"
                                name="tax_amount"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t("invoices.form.fields.discountAmount")}
                            </label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t("invoices.form.fields.totalAmount")}{" "}
                                <span className="text-red-500">*</span>
                            </label>
                            <input
                                type="number"
                            ...
                            />
                            <p className="mt-1 text-xs text-gray-500">
                                {t("invoices.form.hints.calculated", {
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-sm font-medium text-gray-700 mb-1">
                                {t("invoices.form.fields.description")}
                            </label>
                            <textarea
                                name="description"
                                ...
                                rows={3}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md"
                                placeholder={t("invoices.form.placeholders.description")}
                            />
                        </div>
                            ...
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    >
                                        ...
                                        {t("invoices.form.items.addProduct")}
                                    </button>
                                    <button
                                        type="button"
                                    ...
                                    >
                                        <Plus className="w-4 h-4" />
                                        {t("invoices.form.items.addService")}
                                    </button>
                                </div>
                            </div>
                                        ...
                                        <thead className="bg-gray-50">
                                            <tr>
                                                <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">
                                                    {t("invoices.form.items.table.typeProduct")}
                                                </th>
                                                <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">
                                                    {t("invoices.form.items.table.name")}
                                                </th>
                                                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">
                                                    {t("invoices.form.items.table.qty")}
                                                </th>
                                                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">
                                                    {t("invoices.form.items.table.unitPrice")}
                                                </th>
                                                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">
                                                    {t("invoices.form.items.table.taxPercent")}
                                                </th>
                                                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">
                                                    {t("invoices.form.items.table.discountPercent")}
                                                </th>
                                                <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">
                                                    {t("invoices.form.items.table.lineTotal")}
                                                </th>
                                                    ...
                                                    <tr key={idx}>
                                                            ...
                                                            <div className="space-y-2">
                                                                <SearchableSelect
                                                                    ...
                                                                    options={[
                                                                        {
                                                                            value: "product",
                                                                            label: t("invoices.form.items.type.product"),
                                                                        },
                                                                        {
                                                                            value: "service",
                                                                            label: t("invoices.form.items.type.service"),
                                                                        },
                                                                    ]}
                                                                    placeholder={t("invoices.form.items.placeholders.type")}
                                                                />
                                                                ...
                                                                "product" ? (
                                                                    <SearchableSelect
                                                                        ...
                                                                        placeholder={t("invoices.form.items.placeholders.selectProduct")}
                                                                        cacheKey="invoice-modal-products"
                                                                    />
                                                                ) : (
                                                                    <div className="text-xs text-gray-500">
                                                                        {t("invoices.form.items.serviceLine")}
                                                                    </div>
                                                                )}
                                                            </div>
                                                        </td>
                                                        <td className="px-3 py-2 align-top">
                                                            <input
                                                                ...
                                                                placeholder={
                                                                    it.item_type ===
                                                                    "service"
                                                                        ? t("invoices.form.items.placeholders.serviceName")
                                                                        : t("invoices.form.items.placeholders.itemName")
                                                                }
                                                            ...
                                                            <input
                                                                ...
                                                                placeholder={t("invoices.form.items.placeholders.descriptionOptional")}
                                                        ...
                                                        <td className="px-3 py-2 align-top text-right">
                                                            <button
                                                                ...
                                                                title={t("invoices.form.items.actions.remove")}
                                                            >
                                ...
                                <div className="mt-3 flex items-center justify-end text-sm text-gray-700 gap-6">
                                    <div>
                                        <span className="text-gray-500">
                                            {t("invoices.form.items.summary.subtotal")}:
                                        </span>{" "}
                                    ...
                                    <div>
                                        <span className="text-gray-500">
                                            {t("invoices.form.items.summary.tax")}:
                                        </span>{" "}
                                        <span className="font-semibold">
                                    ...
                                    <div>
                                        <span className="text-gray-500">
                                            {t("invoices.form.items.summary.total")}:
                                        </span>{" "}
                                        <span className="font-semibold">
                        ...
                        <div className="md:col-span-2 flex justify-end gap-3 pt-2">
                            ...
                            >
                                {isSubmitting
                                    ? t("common.saving")
                                    : isEdit
                                      ? t("invoices.form.actions.update")
                                      : t("invoices.form.actions.create")}
                            </button>
                        </div>
                    </form>
                </Dialog.Content>
